...
The Min Strøm Enterprise API uses **Bearer** authentication.

## Prerequisites
1. API key
2. API secret

<Card title="Get access" icon="lock-open" href="mailto:engberg@minstroem.app?subject=Enterprise%20API%20access">
