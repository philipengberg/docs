...
<Tabs>
  <Tab title="Address lookup">
    ...
    <Steps>
    <Step title="Search addresses" icon="list" iconType="solid">
    ...
    <Tip>This approach does *not* guarantee the same degree of accuracy of charges as with the [Eloverblik](#prices-including-charges-eloverblik) approach.</Tip>
